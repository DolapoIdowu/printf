...
/**
 * print_base2 - Converts a number from base 10 to base 2.
...
/**
 * print_base8 - Prints the numeric representation of a number in base 8.
...
int print_base8(va_list args)
{
	...
	for (i = 0; decimal_num > 0; i++)
	{
		inverted_octal[i] = (decimal_num % 8) + 48;
		decimal_num /= 8;
	}
	inverted_octal[i] = '\0';
